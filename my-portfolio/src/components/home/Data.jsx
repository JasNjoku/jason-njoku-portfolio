...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Jason Njoku
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Graduate Software Developer</h3>
                <p className="home__description">Recent Software Development graduate from Dundalk Institute of Technology with a 2.1 Honours degree.
                    Enthusiastic about creating reliable software and committed to continuous learning and professional development.
                </p>
